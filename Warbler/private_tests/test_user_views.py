...
class UserViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        with app.app_context():
            ...
            form = UserAddForm()
            form.username.data = "abc"
            form.email.data = "test1@test.com"
            form.password.data = "password"
            form.image_url.data = None

            self.u1 = User.signup(form)
            self.u1_id = 778
            self.u1.id = self.u1_id

            form = UserAddForm()
            form.username.data = "efg"
            form.email.data = "test2@test.com"
            form.password.data = "password"
            form.image_url.data = None

            self.u2 = User.signup(form)
            self.u2_id = 884
            self.u2.id = self.u2_id

            form = UserAddForm()
            form.username.data = "hij"
            form.email.data = "test3@test.com"
            form.password.data = "password"
            form.image_url.data = None

            self.u3 = User.signup(form)

            form = UserAddForm()
            form.username.data = "testing"
            form.email.data = "test4@test.com"
            form.password.data = "password"
            form.image_url.data = None

            self.u4 = User.signup(form)
