...
describe("shortestPath", function() {
  it("should return an array of node values from the start to the target.", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
    ...
    */
    ...
    expect(graph.shortestPath(S,T)).toEqual([
      "S",
      "U",
      "Y",
      "T"
...
describe("hasCycle", function() {
  ...
  it("should return false if graph doesn't have a cycle.", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
  ...
  it("should return true if graph has a cycle that is disconnected.", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
